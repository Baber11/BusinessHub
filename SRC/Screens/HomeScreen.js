...
const HomeScreen = () => {
  ...
  return (
    ...
    >
      ...
      <Chuncks amount={users.filter(item=>item?.status == 'active').length} title={'Active Users'} iconName={'user-shield'}/>
      <Chuncks amount={users.filter(item=>item?.status == 'inactive').length} title={'InActive Users'} iconName={'users-slash'}/>
